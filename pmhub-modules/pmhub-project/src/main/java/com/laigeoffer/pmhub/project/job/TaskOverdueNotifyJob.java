...
import static com.laigeoffer.pmhub.base.notice.utils.MessageUtils.agentid;
import static com.laigeoffer.pmhub.base.notice.utils.MessageUtils.appid;
import static com.laigeoffer.pmhub.base.notice.utils.OAUtils.*;
                ...
                .forEach(taskNotifyDTO -> {
                    ...
                    if (ChronoUnit.DAYS.between(localDate, closeDate) < 0L) {
                        ...
                        if (projectTaskNotify == null) {
                            ...
                            // 设置任务详情页
                            String url = SsoUrlUtils.ssoCreate(appid, agentid, host + path2 + ssoPath + URLEncoder.encode(host + "/pmhub-project/my-task/info?taskId=" + taskNotifyDTO.getTaskId()));
